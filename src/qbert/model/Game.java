...
public class Game {
    ...
    public Game() {
        ...
        try {
          ...
          if (!qbert.temp.Config.DEBUG || new File("../img/png/").listFiles().length < new File("res/svg/").listFiles().length) {
    ...
    private BufferedImage loadImg(String pathOut) throws Exception{
        ...
        final URL spriteUrl = this.getClass().getResource("/png/" + pathOut.split("/")[3]);
        try {
