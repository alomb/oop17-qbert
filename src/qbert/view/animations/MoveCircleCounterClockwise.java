...
public class MoveCircleCounterClockwise implements Animation {
     ...
     */
    public MoveCircleCounterClockwise(final Position2D centerPos, final int startAngle, final int targetAngle) {
